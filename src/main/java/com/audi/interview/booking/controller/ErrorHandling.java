...
import com.audi.interview.booking.controller.dto.SystemMessageDTO;
...
public class ErrorHandling {
    ...
    public ResponseEntity<SystemMessageDTO> vehicleAlreadyBooked(Exception e) {
        log.error("Vehicle already booked: ", e);
